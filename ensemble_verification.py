...
from networks.resnet_18 import avg_ensemble_3_resnet18
...
model_path = 'ensemble_network/models/ensemble_3_resnet18/Test_model.t7'
...
test_data = torchvision.datasets.CIFAR100(root='data/CIFAR100', train=False, download=True, transform=torchvision.transforms.ToTensor())
